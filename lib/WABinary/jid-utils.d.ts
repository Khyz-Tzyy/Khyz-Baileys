...
/** is the jid the newsletter (kept for backward compat with this fork) */
export declare const isJidNewsLetter: (jid: string | undefined) => boolean | undefined;
/** alias matching upstream capitalization */
export declare const isJidNewsletter: (jid: string | undefined) => boolean | undefined;
...
/** move a device id from one jid onto another (e.g. PN -> LID transfer) */
