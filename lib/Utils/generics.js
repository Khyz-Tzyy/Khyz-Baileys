...
// code is inspired by whatsmeow — dipake buat query metadata grup dengan
// parameter `hash`, biar WA server bisa jawab "gak ada perubahan" tanpa
// perlu kirim ulang seluruh daftar participant tiap kali.
const generateParticipantHashV2 = (participants) => {
    const sorted = [...participants].sort();
    const sha256Hash = (0, crypto_1.createHash)('sha256').update(Buffer.from(sorted.join(''))).digest('base64');
