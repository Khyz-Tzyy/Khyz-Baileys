...
exports.PROCESSABLE_HISTORY_TYPES = [
    WAProto_1.proto.Message.HistorySyncType
...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    connectTimeoutMs: 3E4,        // 30s — lebih toleran di koneksi lambat
    keepAliveIntervalMs: 2E4,     // 20s — lebih sering keepalive biar koneksi stabil
    logger: logger_1.default.child({ class: "baileys" }),
    printQRInTerminal: !1,
    emitOwnEvents: !0,
    defaultQueryTimeoutMs: 6E4,
    customUploadHosts: [],
    retryRequestDelayMs: 500,     // 500ms — delay retry lebih aman
    maxMsgRetryCount: 5,
    fireInitQueries: !0,
    auth: void 0,
    ...
    enableAutoSessionRecreation: !0,  // auto recreate session kalau corrupt
    enableRecentMessageCache: !0,     // cache pesan recent biar retry lebih cepat
};
...
exports.MIN_PREKEY_COUNT = 10;   // lebih banyak prekey biar gak cepat habis
exports.INITIAL_PREKEY_COUNT = 50; // upload lebih banyak prekey awal

exports.DEFAULT_CACHE_TTLS = {
    SIGNAL_STORE: 600,    // 10 menit — lebih lama biar gak sering re-fetch
    MSG_RETRY: 3600,
    CALL_OFFER: 300,
    USER_DEVICES: 600     // 10 menit — cache device list lebih lama
};
